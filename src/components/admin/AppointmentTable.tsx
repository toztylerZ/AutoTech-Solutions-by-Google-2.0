                ...
                >
                  ...
                  <td className="p-4">
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-black text-white bg-accent-orange/10 px-2 py-1 rounded text-accent-orange">{app.time || '--:--'}</span>
                      {app.duration > 1 && (
                  ...
                  <td className="p-4">
                    {garageFilter ? (
                      <span className="text-xs text-gray-300 font-medium">{app.service || '—'}</span>
                    ) : (
                      <span className={`text-[10px] font-black uppercase tracking-wider px-3 py-1 rounded-full border ${
                        app.garage === 'Слесарный ремонт и ТО' ? 'bg-blue-500/10 text-blue-400 border-blue-500/20' : 
                        app.garage === 'Электрика и диагностика' ? 'bg-purple-500/10 text-purple-400 border-purple-500/20' : 
                        app.garage === 'Детейлинг и покрытия' ? 'bg-green-500/10 text-emerald-400 border-green-500/20' :
                        'bg-white/5 text-gray-400 border-white/10 italic'
                      }`}>
                  ...
                  <td className="p-4">
                    <div className="flex flex-col">
                      ...
                      <span className="text-[10px] text-gray-500 font-mono tracking-tighter">{app.phone}</span>
                    </div>
                  </td>
